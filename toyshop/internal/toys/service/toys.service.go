...
import (
	...
	"github.com/yasensim/toyshop/toyshop/internal/inventory"
	"github.com/yasensim/toyshop/toyshop/internal/toys"
)
...
func processNewInventory(w http.ResponseWriter, r *http.Request, prod_num string) error {
	...
	//	fmt.Printf("SEND, prod_num: %s, invEndpoint: %s \n", prod_num, invEndpoint)
